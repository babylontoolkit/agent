...
class DemoScene {
    ...
    public static async Load(scene:BABYLON.Scene): Promise<void> {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
        const sampleScene = "samplescene.gltf";
        const playerPrefab = "playerarmature.gltf";
        const playgroundRepo = "https://repo.babylontoolkit.com/playground/";
        const assetsManager = new BABYLON.AssetsManager(scene);
        assetsManager.addMeshTask(sampleScene, null, playgroundRepo, sampleScene);
        assetsManager.addMeshTask(playerPrefab, null, playgroundRepo, playerPrefab);
        await TOOLKIT.SceneManager.LoadRuntimeAssets(assetsManager, [sampleScene, playerPrefab], ()=> {
