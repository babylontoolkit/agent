...
- https://raw.githubusercontent.com/babylontoolkit/agent/main/training/playgrounds/04-DemoPlayerScene.md: Async scene load + physics + player controller pattern.
- https://raw.githubusercontent.com/babylontoolkit/agent/main/training/playgrounds/05-DemoVehicleScene.md: Async scene load + physics + vehicle controller pattern.
...
- Need async loading, runtime initialization, physics, or vehicle control: use `05-DemoVehicleScene.md`.
